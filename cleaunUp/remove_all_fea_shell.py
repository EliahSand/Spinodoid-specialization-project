...
Usage:
  python3 cleanUp/remove_all_fea_shell.py
  python3 cleanUp/remove_all_fea_shell.py --dry-run
  python3 cleanUp/remove_all_fea_shell.py --root Matlab/GNN/data/raw/samples
"""
